        ...
        <div className="flex-1">
            ...
            {declinedOrders.length === 0 ? (
                <div className="text-center py-16 bg-white rounded-xl border border-gray-100">
                    <RotateCcw className="w-14 h-14 text-gray-200 mx-auto mb-4" />
                    <p className="text-gray-500 mb-2">No returns</p>
                        ...
                        >
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-medium px-2.5 py-1 rounded-full flex items-center gap-1 text-red-600 bg-red-50">
